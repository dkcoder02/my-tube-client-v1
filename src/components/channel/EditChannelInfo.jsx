        ...
        <>
          <div className="relative min-h-[150px] w-full pt-[16.28%]">
            <div className="absolute inset-0 overflow-hidden">
              <img
                src={authInfo.coverImage ? authInfo.coverImage : ""}
                alt="cover-photo"
              />
            </div>
          </div>
              ...
              <div className="flex flex-wrap gap-y-4 p-4">
                ...
                <div className="flex w-full items-center gap-3">
                  <div className="w-full max-w-xs rounded-lg border">
                    <select className="w-full bg-[#121212] border-r-8 border-transparent  py-1.5 pl-2">
                ...
                <div className="w-full ">
                  ...
                  <div className="relative w-full rounded-lg border">
                    ...
                    <select
                      id="timezone"
                      className="w-full bg-[#121212] border-r-8 border-transparent py-1.5 pl-8"
                    >
