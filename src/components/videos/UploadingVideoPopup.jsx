        ...
        <div className="w-full max-w-lg overflow-auto rounded-lg border border-gray-700 bg-[#121212] p-4">
          ...
          <div className="mb-6 flex gap-x-2 border p-3">
            <div className="w-8 shrink-0">
              <span className="inline-block w-full rounded-full bg-orange-300 p-1 text-orange-500">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
            ...
            <div className="flex flex-col">
              <h6>{state.videoInfo?.name}</h6>
              <p className="text-sm">
                {(state.videoInfo?.size / 1048576).toFixed(2).toString() +
                  " MB"}
              </p>
              {uploading ? (
                <div className="mt-2">
                ...
                <>
                  <div className="mt-2 flex items-center">
                    <span className="mr-2 inline-block w-6 text-orange-500">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 20 20"
                        fill="currentColor"
          ...
          <div className="grid grid-cols-12 gap-4">
            ...
            >
              <Button
                size="lg"
                variant="secondary"
                className="bg-orange-500  px-4 py-3 text-black disabled:bg-[#E4D3FF]"
                disabled=""
              >
                Finish
              </Button>
